...
/**
 * Clase que representa a los defensas
 */
public class Defensa extends Jugador implements InterfazDefensiva
{
    public Defensa ()
    {
        super();
    ...
    public Defensa(int numID, String nombre, String demarcacion, int valor, int points, int clausula, String team, int minutos, int numGoles, int numAssist, boolean expulsado, boolean disponible, boolean enVenta, Usuario dueno, int numParadas, int numPenaltisParados, int numGolesContra, int valoracion, int puntosTotales)
    {
    ...
    public int puntuacionTotal()
    {
        ...
        int f = minutosJugados();

        int puntuacion = a+b+c+d+e+f;
        return puntuacion;
    }
